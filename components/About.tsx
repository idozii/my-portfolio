...
export default function About() {
  return (
    <section id="about" className="scroll-mt-16 relative overflow-hidden">
      ...
      <div className="flex flex-col gap-4 lg:px-6 mb-8 relative z-10">
      ...
      <div className="flex flex-col gap-4 relative z-10">
        <p className="text-start text-sm text-slate-700 dark:text-slate-300 leading-relaxed lg:px-6 animate-slide-up hover:text-slate-600 dark:hover:text-slate-200 transition-colors duration-300">
          ...
          <span className="text-transparent bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text font-medium">Macquarie Associate Computing Students</span> and{" "}
